...
const experiences = [
  ...
  // },
  {
    ...
    company_name: "Medanta The Medicity",
...
const projects = [
  {
    name: "Threads Clone",
    description:
      "Developed a Full-Stack Threads Clone using Next.js 14+, TypeScript, and MongoDB, implementing features like real-time notifications, nested comments, authentication, and optimized search for enhanced user engagement and performance. Engineered a scalable and responsive UI with Tailwind CSS, Shadcn UI, and Figma-based designs, integrating server-less APIs, role-based community management, and file uploads to ensure seamless interaction and accessibility",
    tags: [
      {
        name: "typescript",
    ...
    source_code_link: "https://github.com/puneetshukla14/Threads-main",
    deployed_link: "https://threads-one-theta.vercel.app/",
  },
  {
    name: "DisneyHotstarClone",
    description:
      "Project Highlight: Disney Hotstar Clone As a dedicated software developer, I undertook the challenge of building a Disney Hotstar Clone from the ground up and successfully deployed it on GitHub. This project exemplifies my expertise in full-stack development, user experience design, and cloud deployment. ",
    tags: [
      {
        name: "typescript",
        color: "blue-text-gradient",
    ...
    source_code_link: "https://github.com/puneetshukla14/DisneyHotstarClone",
    deployed_link: "https://disneyhotstar-henna.vercel.app/",
  },
  // {
  //   name: "GDSC Website",
  //   description:
  ...
  // },
  {
    ...
    image: "/assets/projects/paper.png",
    source_code_link:
      "https://github.com/puneetshukla14/Research_Ppaer_Emotional_Intelligence_In-AI_Chatbot",
    deployed_link:
      "https://zenodo.org/records/14838063",
  },
  // {
  //   name: "Netflix Clone",
  //   description:
...
const socials = [
  {
    id: "github",
    icon: <GithubIcon />,
    link: "https://github.com/puneetshukla14?tab=repositories",
  },
  {
    id: "linkedin",
    icon: <LinkedInIcon />,
    link: "https://www.linkedin.com/in/puneet-shukla-72b915225/",
  },
  {
    id: "x",
    icon: <XIcon />,
  ...
  },
  {
    id: "instagram",
    icon: <InstagramIcon />,
    link: "https://www.instagram.com/puneet_146/",
  },
];
